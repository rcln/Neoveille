...
public class Main {
    ...
    //Titles: has a file with text annotation such as "<text id='4' newspaper='Taxydromos' year='2015' month='09' day='06'>".
    //vrtTexts: has files with positional attributes (such as lemma and part-of-speech tags).
    //XMLvrtTexts: has files with structural attributes (such as annotations for sentences and texts).
